...
namespace Editor.ProtocolTool.Csharp
{
    public class CsharpGenerator
    {
        ...
        private MessageHandlerGenerator messageHandlerGenerator;
        private MessagePoolGenerator messagePoolGenerator;

        public CsharpGenerator(string xmlPath, string classPath)
        {
            XML_PATH = xmlPath;
            CLASS_PATH = classPath;
            MESSAGE_POOL_PATH = classPath;
            MESSAGE_HANDLER_PATH = classPath + "Handler/";
            
            messageHandlerGenerator = new MessageHandlerGenerator(MESSAGE_HANDLER_PATH);
            messagePoolGenerator = new MessagePoolGenerator(MESSAGE_POOL_PATH);
        }
        ...
        public void Start()
        {
            ...
            messagePoolGenerator.Generate(messageList);
            
            // generate message handler
            messageHandlerGenerator.Generate(messageList);
